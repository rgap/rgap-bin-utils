...
Usage:
    rgap_pdf2png_file.py (--c|<input_dir>) <output_dir> [--suffix] [--margins="<margins>"]
    rgap_pdf2png_file.py (--c|<input_dir>) [--suffix] [--margins="<margins>"]

    rgap_pdf2png_file.py -h
